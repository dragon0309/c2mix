...
; postcondition
(assert (not (and (eqmodP2 (PMul (PConst s__r_1) (PPow (PVar vx) 3)) (PMul (PAdd (PConst s__a_0) (PConst s__b_0)) (PVar vx)) (PConst 3) (PAdd (PPow (PVar vx) 2) (PConst (- 1)))) (eqmodP1 (PConst s__r_1) (PAdd (PConst s__b_0) (PConst s__a_0)) (PConst 7)))))
; check
(check-sat)
(exit)
