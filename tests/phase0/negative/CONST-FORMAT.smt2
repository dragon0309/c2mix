...
(assert (and (bvslt (_ bv49152 16) a_0) (bvslt a_0 #x4000) (bvslt #xC000 b_0) (bvslt b_0 #x4000)))
...
; postcondition
(assert (not (and (eqmodP2 (PMul (PConst s__r_1) (PPow (PVar "x") 3)) (PMul (PAdd (PConst s__a_0) (PConst s__b_0)) (PVar "x")) (PConst 3) (PAdd (PPow (PVar "x") 2) (PConst (- 1)))) (eqmodP1 (PConst s__r_1) (PAdd (PConst s__b_0) (PConst s__a_0)) (PConst 7)))))
; check
(check-sat)
(exit)
