...
(declare-const r.1 (_ BitVec 16))
(declare-const s__a_0 Int)
(declare-const s__b_0 Int)
(declare-const s__r.1 Int)
...
(assert (= r.1 (bvadd a_0 b_0)))
(assert (= s__r.1 (- (bv2nat r.1) (* 65536 (bv2nat ((_ extract 15 15) r.1))))))
(assert (= c_1 ((_ extract 15 15) r.1)))
; algebraic precondition and program
(assert true)
(assert (eqP (PConst s__r.1) (PAdd (PConst s__a_0) (PConst s__b_0))))
(assert (eqP (PMul (PConst (bv2nat c_1)) (PConst (bv2nat c_1))) (PConst (bv2nat c_1))))
; postcondition
(assert (not (and (eqmodP2 (PMul (PConst s__r.1) (PPow (PVar "x") 3)) (PMul (PAdd (PConst s__a_0) (PConst s__b_0)) (PVar "x")) (PConst 3) (PAdd (PPow (PVar "x") 2) (PConst (- 1)))) (eqmodP1 (PConst s__r.1) (PAdd (PConst s__b_0) (PConst s__a_0)) (PConst 7)))))
; check
(check-sat)
(exit)
